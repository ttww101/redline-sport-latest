...
- (BOOL)parseText:(NSMutableAttributedString *)text selectedRange:(NSRangePointer)selectedRange {
    ...
    
    {
        ...
        dispatch_once(&onceToken, ^{
            ...
            topicExtImages = @[
                [UIImage imageNamed:@"timeline_card_small_movie"],
                [UIImage imageNamed:@"timeline_card_small_book"],
                [UIImage imageNamed:@"timeline_card_small_music"],
                [UIImage imageNamed:@"timeline_card_small_location"],
                [UIImage imageNamed:@"timeline_card_small_stock"]
            ];
        });
        
        NSArray<NSTextCheckingResult *> *topicResults = [[WBStatusHelper regexTopic] matchesInString:text.string options:kNilOptions range:text.yy_rangeOfAll];
    ...
    {
        NSArray<NSTextCheckingResult *> *atResults = [[WBStatusHelper regexAt] matchesInString:text.string options:kNilOptions range:text.yy_rangeOfAll];
        for (NSTextCheckingResult *at in atResults) {
            ...
            [text yy_setColor:_highlightTextColor range:at.range];
        }
    }
    
    {
        NSArray<NSTextCheckingResult *> *emoticonResults = [[WBStatusHelper regexEmoticon] matchesInString:text.string options:kNilOptions range:text.yy_rangeOfAll];
        NSUInteger clipLength = 0;
