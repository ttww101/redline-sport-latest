...
- (RLSPeilvViewOfPlyc *)peilvView
{
    if (!_peilvView) {
        _peilvView = [[RLSPeilvViewOfPlyc alloc] init];
    }
    return _peilvView;
}
- (void)addlayout
