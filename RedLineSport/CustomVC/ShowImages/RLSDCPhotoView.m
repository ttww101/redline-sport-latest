...
@interface RLSDCPhotoView ()<UIScrollViewDelegate>
{
    UIScrollView *_scrollView;
}
@end
@implementation RLSDCPhotoView
-(id)initWithFrame:(CGRect)frame withPhotoUrl:(NSString *)photoUrl{
    ...
    if (self) {
        ...
        [self.imageView sd_setImageWithURL:[NSURL URLWithString:photoUrl] placeholderImage:[UIImage imageNamed:@"DefaultTeam"] options:0 progress:^(NSInteger receivedSize, NSInteger expectedSize){
